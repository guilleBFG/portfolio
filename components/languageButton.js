    ...
    <div className="lg:inline-flex lg:w-auto w-full px-3 py-2 rounded text-white font-bold items-center justify-cente">
      <Menu as="div" className="relative inline-block text-left">
        <div className="text-left object-left">
          <Menu.Button className="inline-flex w-full justify-center rounded-md bg-black bg-opacity-20 px-4 py-2 text-sm font-medium text-white hover:bg-opacity-40 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
            Language
            <ChevronDownIcon
                        ...
                        <button
                          className={`${
                            active
                              ...
                              : "text-white"
                          } lg:inline-flex lg:w-auto w-full px-3 py-2 rounded text-white font-bold items-center justify-center bg-gradient-to-r  hover:from-pink-500 hover:to-pink-300`}
                        >
                          {locale}
                        </button>
                      </a>
